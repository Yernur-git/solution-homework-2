...
Read textual commands (like move forward, pick up sword, inventory) and identify the main command plus any arguments (e.g., forward, sword).
Room & Movement Logic:
...
Submission
Implement the methods in MUDController.java without modifying method signatures.

Provide instructions (or a short Main method) showing how to compile/run your code.

Submit your github link to Canvas

For extra credit, add at least one new command (like attack, open door, or talk) to demonstrate extension.
